...
-- LERB ürünleri: hepsi ekskavatöre monte edilen ataşman (açıklamalarda "suitable Excavator"/"Excavator requirements" ibaresi var)
update market_requests set kategori = 'atasman' where id in (
  '004568c3-a6db-4561-adb0-d9efd2118473', -- Hydraulic Single-unit Splitter (P280)
  'ffa8e62f-3e67-4395-9a9f-5786e21777db', -- Single unit splitter (P240)
  '7fcafa2f-a104-4aae-84c1-3c7c5de5c2e8', -- Hydraulic Drilling Rig (T6)
  '1ff6dd86-606d-45c6-a90c-0cf29c000c44', -- Hydraulic Drilling Rig (T2)
  'c0154096-4ce0-488a-b4c3-b081d5fac286', -- Hydraulic Drilling Rig (T1)
  '80e128d2-76df-4b73-a31f-3a4f2b86ea62', -- Fully Hydraulic Rock drilling&splitting Machine (PL3000LQ)
  'f31cc56d-19e4-4ca2-a96f-e110eae7e1c3', -- Fully Hydraulic Rock drilling&splitting Machine (PL2000LQ)
  '21f4a483-6a23-4bf3-8092-c4fb59ed8b62', -- Fully Hydraulic Rock drilling&splitting Machine (PL2000LQ)
  '0d4381bc-d5b5-4266-9621-bc8f5ed04cc1', -- Fully Hydraulic Rock drilling&splitting Machine (PL1500L)
  'e4c468fb-2e5d-44a8-90d2-0c9f93ef1ec5',  -- Fully Hydraulic Rock drilling&splitting Machine (PL1000L)
  '85b06855-7b24-4b27-a126-4a081d794cdb'  -- Ekskavatör Kovası ve Ataşman İmalatı (İntromak)
);

update market_requests set kategori = 'makine' where id in (
  'c4a696f2-495a-4f98-b0e5-1f7aac6587e1' -- 2023 Model Yanmar Mini Ekskavatör
);
